...
| `Alertmanager data source`      | The [Alertmanager data source]({{< relref "./alertmanager/" >}}) to use for alert management.                                                                                                                                                                                                                   |
...
datasources:
  - name: Prometheus
    ...
    jsonData:
      httpMethod: POST
      manageAlerts: true
      # UID for the accompanying Alertmanager data source
      alertmanagerUid: P1243D72C4FB5C4F1
